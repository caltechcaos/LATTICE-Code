...
namespace ShuttleConstants{
 ...
 constexpr double kMaxInputVoltage = 3.3; //temp (dependson fully charge bat and resistor)
 constexpr double kMultiplier = 1.005; //temp (depends on how much of the origional voltage is inputed)(I.E. 1/3)
}
